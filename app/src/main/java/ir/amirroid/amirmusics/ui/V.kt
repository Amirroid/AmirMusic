package ir.amirroid.amirmusics.ui
...
class BarVisualizer constructor(
    context: Context,
    color: Int
) : VisualizerBase(context) {

    companion object {
        private const val barWidth = 3f        // [dp]
        private const val gapWidth = 2f        // [dp]
    }
